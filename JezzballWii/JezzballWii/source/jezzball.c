...
void jezzballDraw()
{
	...
	{
		Rect box = { 77, 84, 165, 84 }; 
		Rect box2 = { 73, 80, 173, 92 }; 
		...
		drawString(FONTFAMILY_VERDANA14, 320, 228, levelCompleteText, TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
		drawString(FONTFAMILY_VERDANA14, 320, 252, i18nPressAToContinue(), TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
	}
	else if(gameover)
	{
		drawScore();
		...
		drawString(FONTFAMILY_VERDANA14, 320, 228, i18nGameOver(), TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
		drawString(FONTFAMILY_VERDANA14, 320, 252, i18nPressAToTryAgain(), TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
		...
		drawString(FONTFAMILY_VERDANA14, 320, 360, i18nGameOver(), TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
		drawString(FONTFAMILY_VERDANA14, 320, 390, i18nPressAToTryAgain(), TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);

		drawString(FONTFAMILY_VERDANA14, 115, 112, i18nPlayer(), TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
		drawString(FONTFAMILY_VERDANA14, 249, 112, i18nLevel(), TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
		drawString(FONTFAMILY_VERDANA14, 417, 112, i18nScore(), TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
		...
		for(i=0; i < highscoreCount; i++)
		{
			...
			drawString(FONTFAMILY_VERDANA14, 120, 32 + ((i+1)*13), playerText, TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
			drawString(FONTFAMILY_VERDANA14, 220, 32 + ((i+1)*13), levelText, TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
			drawString(FONTFAMILY_VERDANA14, 290, 32 + ((i+1)*13), scoreText, TEXT_ALIGN_CENTER, 0xFE, 0xFE, 0xFE);
...
void drawBackground() {
	...
	Rect shadow = {DRAWING_OFFSET_X+4,DRAWING_OFFSET_Y+4,MAP_WIDTH*8,MAP_HEIGHT*8};
	drawRect(&shadow, 0,0,0,0xFF);
...
{	
	...
	bg.y = 45/2; drawRect(&bg, 0,0,0,0xFF);
	drawString(FONTFAMILY_VERDANA14_BOLD, 5, 45, i18nLevel(), TEXT_ALIGN_LEFT,0,0,0);  
	bg.y = 100/2; drawRect(&bg, 0,0,0,0xFF);
	drawString(FONTFAMILY_VERDANA14_BOLD, 5, 100, i18nCompleted(), TEXT_ALIGN_LEFT,0,0,0); 
	bg.y = 155/2; drawRect(&bg, 0,0,0,0xFF);
	drawString(FONTFAMILY_VERDANA14_BOLD, 5, 155, i18nLives(), TEXT_ALIGN_LEFT,0,0,0); 
	bg.y = 210/2; drawRect(&bg, 0,0,0,0xFF);
	drawString(FONTFAMILY_VERDANA14_BOLD, 5, 210, i18nScore(), TEXT_ALIGN_LEFT,0,0,0); 
	bg.y = 265/2; drawRect(&bg, 0,0,0,0xFF);
	drawString(FONTFAMILY_VERDANA14_BOLD, 5, 265, i18nTimeLeft(), TEXT_ALIGN_LEFT,0,0,0);

	bg.w = 59;
	bg.h = 13;
	bg.x = 10;

	bg.y = 72/2; drawRect(&bg, 0xFF,0xFF,0xFF,0xFF);
	drawString(FONTFAMILY_VERDANA14, 130, 72, levelText, TEXT_ALIGN_RIGHT,0xFF,0xFF,0xFF); 
	bg.y = 127/2; drawRect(&bg, 0xFF,0xFF,0xFF,0xFF);
	drawString(FONTFAMILY_VERDANA14, 130, 127, completedText, TEXT_ALIGN_RIGHT,0xFF,0xFF,0xFF); 
	bg.y = 182/2; drawRect(&bg, 0xFF,0xFF,0xFF,0xFF);
	drawString(FONTFAMILY_VERDANA14, 130, 182, livesText, TEXT_ALIGN_RIGHT,0xFF,0xFF,0xFF); 
	bg.y = 237/2; drawRect(&bg, 0xFF,0xFF,0xFF,0xFF);
	drawString(FONTFAMILY_VERDANA14, 130, 237, scoreText, TEXT_ALIGN_RIGHT,0xFF,0xFF,0xFF); 
	bg.y = 292/2; drawRect(&bg, 0xFF,0xFF,0xFF,0xFF);
	drawString(FONTFAMILY_VERDANA14, 130, 292, timeText, TEXT_ALIGN_RIGHT,0xFF,0xFF,0xFF); 
